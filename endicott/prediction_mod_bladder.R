...
fit1<-pred_multinom(X=Xpred,Y=preddat$observed_Bladder,cID=cID,offs=preddat$Pop,nsamp=200000,nburn=10000)

save(fit1,file='bladder_output.RData')

pdf('bladder_traceplots.pdf',width=12)
par(mfrow=c(3,4))
for (i in 1:11){

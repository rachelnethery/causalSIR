##############################################################################################
## CSIR ESTIMATION SIMULATIONS WITH X->T RELATIONSHIP, X->Y RELATIONSHIP, T->Y RELATIONSHIP ##
...
save(csir_results,pr_results,cdc_results,file=paste0('sim4_',trueSIR,'.RData'))
